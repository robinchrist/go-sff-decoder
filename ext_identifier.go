...
var ExtIdentifierDescss8079 = map[byte]string{
...
func getExtIdentifierDescs8079(v byte) []string {
	name, ok := ExtIdentifierDescss8079[v]
	if !ok {
...
func getExtIdentifierDescs8636(v byte) []string {
	s := []string{
