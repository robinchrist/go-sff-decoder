...
var transceivers8636 = map[uint64]string{
	(1 << 7):        "Extended (SFF-8636 2.10a 6.3.23)",
	(1 << 6):        "10G Ethernet: 10G Base-LRM",
	(1 << 5):        "10G Ethernet: 10G Base-LR",
	(1 << 4):        "10G Ethernet: 10G Base-SR",
	...
	(1 << (7 + 8)):  "SONET: Reserved",
	(1 << (6 + 8)):  "SONET: Reserved",
	(1 << (5 + 8)):  "SONET: Reserved",
	(1 << (4 + 8)):  "SONET: Reserved",
	(1 << (3 + 8)):  "SONET: Reserved",
	(1 << (2 + 8)):  "SONET: OC-48, long reach",
	(1 << (1 + 8)):  "SONET: OC-48, intermediate reach",
	(1 << (0 + 8)):  "SONET: OC-48, short reach",
	(1 << (7 + 16)): "SAS 24.0G",
	...
	(1 << (1 + 16)): "SAS: Reserved",
	(1 << (0 + 16)): "SAS: Reserved",
	(1 << (7 + 24)): "Gigabit Ethernet: Reserved",
	(1 << (6 + 24)): "Gigabit Ethernet: Reserved",
	(1 << (5 + 24)): "Gigabit Ethernet: Reserved",
	(1 << (4 + 24)): "Gigabit Ethernet: Reserved",
	(1 << (3 + 24)): "Gigabit Ethernet: 1000BASE-T",
	(1 << (2 + 24)): "Gigabit Ethernet: 1000BASE-CX",
	(1 << (1 + 24)): "Gigabit Ethernet: 1000BASE-LX",
	(1 << (0 + 24)): "Gigabit Ethernet: 1000BASE-SX",
	(1 << (7 + 32)): "FC: very long distance (V)",
	(1 << (6 + 32)): "FC: short distance (S)",
	(1 << (5 + 32)): "FC: intermediate distance (I)",
	(1 << (4 + 32)): "FC: long distance (L)",
	...
	(1 << (4 + 56)): "FC: 400 Mb/s",
	(1 << (2 + 56)): "FC: 200 Mb/s",
	(1 << (1 + 56)): "FC: Extended (SFF-8636 2.10a 6.3.23)",
	(1 << (0 + 56)): "FC: 100 Mb/s",
}
...
func get8079TransceiverSpecComplianceDescs(t Transceiver) []string {
	r := []string{}
...
func get8636TransceiverSpecComplianceDescs(t Transceiver) []string {
	r := []string{}
